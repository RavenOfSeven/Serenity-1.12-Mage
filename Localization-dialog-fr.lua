...
--	};
	...
	SERENITY_MESSAGE = {
		...
		["Interface"] = {
			["Welcome"] = "<white>/serenity or /seren to show the setting menu!",
		...
		["Help"] = {
			"/seren recall -- Center Serenity and all buttons in the middle of the screen",
			"/seren sm -- Replace messages with a short raid-ready version",
			"/seren reset -- Restore and reload default Serenity configurations"
