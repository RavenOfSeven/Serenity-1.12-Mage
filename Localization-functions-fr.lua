...
function Serenity_SpellTableBuild()
	...
	[1] = {ID = nil, Rank = nil, CastTime = nil, Mana = nil,
		Name = "Abolish Disease",				Length = 0,		Type = 0},
	...
	[14] = {ID = nil, Rank = nil, CastTime = nil, Mana = nil,
		Name = "Greater Heal",					Length = 0,		Type = 0},
...
SERENITY_DRINK = {
	...
	[22] = { Name = "Bottled Alterac Spring Water", Energy = 4410, Level = 55,
		Length = 30, Conjured = false, PvP = false },	
	[23] = { Name = "Conjured Crystal Water",		Energy = 4200, Level = 55,
		Length = 30, Conjured = true, PvP = false },	
};
...
SERENITY_MOUNT_TABLE = {
	...
	-- [2] Ram Icon
	{ "Stormpike Battle Charger", "Black Ram", "Black War Ram", "Brown Ram", "Frost Ram", "Gray Ram", "Swift Brown Ram", "Swift Gray Ram", "Swift White Ram", },
	-- [3] Raptor Icon            
